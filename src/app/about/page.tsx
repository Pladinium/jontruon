...
export default function AboutPage() {
  ...
  return (
    <main
      className={`mt-[7%] flex flex-col items-center justify-center min-h-screen
        bg-[var(--background)] text-[var(--foreground)]
        transition-colors duration-500 ease-out will-change-transform
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 place-items-center">
            <div className="w-full max-w-[600px] text-center space-y-4">
              <h5 className="text-xl font-bold">{language === "EN" ? "Top 5 Fixed-Wing Aircraft" : "Top 5 avions"}</h5>
                ...
                <div className="relative aspect-[5/3] w-full overflow-hidden bg-[var(--background)] transition-all duration-500 ease-out">
            ...
            <div className="w-full max-w-[600px] text-center space-y-4">
              <h5 className="text-xl font-bold">{language === "EN" ? "Top 5 Helicopters" : "Top 5 hélicoptères"}</h5>
                ...
                <div className="relative aspect-[5/3] w-full overflow-hidden bg-[var(--background)] transition-colors duration-500 ease-out">
                  <AnimatePresence mode="wait">
                    <motion.div
                      key={helicopter.name}
                      initial={{ opacity: 0, x: direction > 0 ? 100 : -100 }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8">
            {fragranceList.map((fragrance, idx) => (
              <motion.div
                ...
                transition={{ duration: 0.4, delay: idx * 0.1 }}
                viewport={{ once: true }}
                className="rounded-xl overflow-hidden shadow-2xl bg-[var(--background)]
                          transition-colors duration-300 hover:scale-105 hover:-translate-y-1"
              >
